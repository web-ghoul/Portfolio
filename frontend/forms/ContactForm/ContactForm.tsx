...
const ContactForm=()=> {
  ...
  return (
    <form
      className="grid justify-stretch items-center gap-8"
      onSubmit={handleSubmit}
    >
      <div className="flex justify-center items-center gap-8">
        <LabelInputContainer>
          <Label htmlFor="firstname">First name</Label>
          <Input id="firstname" placeholder="Mahmoud" type="text" />
        </LabelInputContainer>
        <LabelInputContainer>
          <Label htmlFor="lastname">Last name</Label>
          <Input id="lastname" placeholder="Salama" type="text" />
        </LabelInputContainer>
      </div>
      <LabelInputContainer className="mb-4">
        ...
        <Input
          id="email"
          placeholder="mahmoudaboraya2021@gmail.com"
          type="email"
        />
      </LabelInputContainer>
      <LabelInputContainer className="mb-4">
