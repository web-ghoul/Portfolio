...
const HeroSection = () => {
    return (
        <section className="contain hero grid justify-stretch items-center gap-10 grid-cols-2 relative">
            <DotsIcon className="absolute top-[50%] translate-y-[-50%] left-0 w-[100px] h-auto z-10 text-gray-400" />
            ...
            <div className="relative grid justify-end items-center">
                ...
                <DotsIcon className="absolute top-[10%] right-0 w-[150px] h-auto z-1 text-gray-400" />
            </div>
        </section>
    )
}
