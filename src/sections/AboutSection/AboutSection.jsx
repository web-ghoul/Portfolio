                ...
                <Box className={`grid jcfs aic gm ${styles.about_part}`}>
                    ...
                    <Box className={`flex jcfs aic`}>
                        <Typography variant='h5' className={`${styles.text_about}`}>
                            I am Mahmoud Salama , 22 years old , a Front-End developer with a vast array of knowledge in many different front end and back end languages, responsive frameworks, databases, and best code practices.
                            <br/>
