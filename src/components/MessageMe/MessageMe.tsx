...
const MessageMe = () => {
    return (
        <div className="border border-primary_border p-3 grid justify-stretch items-center gap-4 max-tablet:gap-3.5 max-small:gap-3">
            <h6 className="text-foreground">Message me here</h6>
            <div className="grid justify-stretch items-center gap-3 text-gray-500 dark:text-gray-400 max-laptop:gap-2.5 max-mobile:gap-2">
